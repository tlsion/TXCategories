...
*/
@interface UIImage (TXAnimatedGIF)

/*
        UIImage *animation = [UIImage tx_animatedImageWithAnimatedGIFData:theData];
...
*/
+ (UIImage *)tx_animatedImageWithAnimatedGIFData:(NSData *)theData;

/*
        UIImage *image = [UIImagetx_ animatedImageWithAnimatedGIFURL:theURL];
...
*/
+ (UIImage *)tx_animatedImageWithAnimatedGIFURL:(NSURL *)theURL;
