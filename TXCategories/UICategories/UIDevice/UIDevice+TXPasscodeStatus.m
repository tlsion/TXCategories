...
@implementation UIDevice (TXPasscodeStatus)

- (BOOL)tx_passcodeStatusSupported
{
...
#pragma clang diagnostic pop
        ...
        if (status == errSecDecode) {
            return TXPasscodeStatusDisabled;
        }
        ...
        if (status == errSecSuccess) {
            return TXPasscodeStatusEnabled;
        }
