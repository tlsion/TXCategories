...
@implementation UIFont (TXTTF)

+ (UIFont *)tx_fontWithTTFAtURL:(NSURL *)URL size:(CGFloat)size{
	...
	return [UIFont tx_fontWithTTFAtPath:URL.path size:size];
}

+ (UIFont *)tx_fontWithTTFAtPath:(NSString *)path size:(CGFloat)size{
