...
@implementation UIImageView (TXGeometryConversion)
...
- (CGRect)tx_convertRectFromImage:(CGRect)imageRect {
    ...
    CGPoint viewTopLeft     = [self tx_convertPointFromImage:imageTopLeft];
    CGPoint viewBottomRight = [self tx_convertPointFromImage:imageBottomRight];
...
- (CGRect)tx_convertRectFromView:(CGRect)viewRect {
    ...
    CGPoint imageTopLeft = [self tx_convertPointFromView:viewTopLeft];
    CGPoint imageBottomRight = [self tx_convertPointFromView:viewBottomRight];
