...
typedef struct TXBezierSubpath {
    CGPoint startPoint;
...
@implementation UIBezierPath (TXLength)
...
- (void)extractSubpaths:(TXBezierSubpath*)subpathArray
{
...
- (CGPoint)pointAtPercent:(CGFloat)t ofSubpath:(TXBezierSubpath)subpath {
...
- (CGFloat)tx_length {
	...
	TXBezierSubpath subpaths[subpathCount];
...
- (CGPoint)tx_pointAtPercentOfLength:(CGFloat)percent {
    ...
    TXBezierSubpath subpathContainingPoint;
	for (NSUInteger i = 0; i < subpathCount; i++) {
