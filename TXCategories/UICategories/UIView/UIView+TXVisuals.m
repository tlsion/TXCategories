...
// Degree -> Rad
#define tx_degToRad(x) (M_PI * (x) / 180.0)

@implementation UIView (TXVisuals)

///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////

-(void)tx_cornerRadius: (CGFloat)radius strokeSize: (CGFloat)size color: (UIColor *)color
{
...
///////////////////////////////////////////////////////////////////////////////////////////////////
-(void)tx_setRoundedCorners:(UIRectCorner)corners radius:(CGFloat)radius {
...
-(void)tx_shadowWithColor: (UIColor *)color
...
-(void)tx_removeFromSuperviewWithFadeDuration: (NSTimeInterval)duration
{
...
-(void)tx_addSubview: (UIView *)subview withTransition: (UIViewAnimationTransition)transition duration: (NSTimeInterval)duration
{
	[UIView beginAnimations: nil context: NULL];
	[UIView setAnimationDuration: duration];
...
-(void)tx_removeFromSuperviewWithTransition: (UIViewAnimationTransition)transition duration: (NSTimeInterval)duration
{
	[UIView beginAnimations: nil context: NULL];
	[UIView setAnimationDuration: duration];
...
-(void)tx_rotateByAngle: (CGFloat)angle
      ...
      timingFunction: (CAMediaTimingFunction *)timingFunction
{
    ...
    rotation.toValue = [NSNumber numberWithFloat: tx_degToRad(angle)];
...
-(void)tx_moveToPoint: (CGPoint)newPoint 
          duration: (NSTimeInterval)duration 
       autoreverse: (BOOL)autoreverse
       repeatCount: (CGFloat)repeatCount
    timingFunction: (CAMediaTimingFunction *)timingFunction
