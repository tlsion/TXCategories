...
typedef NS_ENUM(NSInteger, TXImagePosition) {
...
@interface UIButton (TXImagePosition)
 ...
 */
- (void)tx_setImagePosition:(TXImagePosition)postion spacing:(CGFloat)spacing;
