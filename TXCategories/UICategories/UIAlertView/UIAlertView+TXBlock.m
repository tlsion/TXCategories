...
@implementation UIAlertView (TXBlock)
...
+ (void)tx_alertWithCallBackBlock:(UIAlertViewTXCallBackBlock)alertViewCallBackBlock title:(NSString *)title message:(NSString *)message  cancelButtonName:(NSString *)cancelButtonName otherButtonTitles:(NSString *)otherButtonTitles, ...NS_REQUIRES_NIL_TERMINATION {
...
- (UIAlertViewTXCallBackBlock)tx_alertViewCallBackBlock {
...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex {
    ...
    if (self.tx_alertViewCallBackBlock) {
        self.tx_alertViewCallBackBlock(buttonIndex);
    }
}
