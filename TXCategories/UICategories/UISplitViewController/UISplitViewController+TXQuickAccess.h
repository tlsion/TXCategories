...
@interface UISplitViewController (TXQuickAccess)

@property (weak, readonly, nonatomic) UIViewController *tx_leftController;
@property (weak, readonly, nonatomic) UIViewController *tx_rightController;
