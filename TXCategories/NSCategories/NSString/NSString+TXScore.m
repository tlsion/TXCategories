...
@implementation NSString (TXScore)

- (CGFloat)tx_scoreAgainst:(NSString *)otherString{
    return [self tx_scoreAgainst:otherString fuzziness:nil];
}

- (CGFloat)tx_scoreAgainst:(NSString *)otherString fuzziness:(NSNumber *)fuzziness{
    return [self tx_scoreAgainst:otherString fuzziness:fuzziness options:NSStringTXScoreOptionNone];
}

- (CGFloat)tx_scoreAgainst:(NSString *)anotherString fuzziness:(NSNumber *)fuzziness options:(NSStringTXScoreOption)options{
    ...
    if(NSStringTXScoreOptionFavorSmallerWords == (options & NSStringTXScoreOptionFavorSmallerWords)){
    ...
    if(NSStringTXScoreOptionReducedLongStringPenalty == (options & NSStringTXScoreOptionReducedLongStringPenalty)){
