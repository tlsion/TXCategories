...
@implementation NSString (TXTranslation)

+ (NSString *)translationArebicToChinese:(NSString *)arebic{
    if(arebic == nil)
    {
        return @"";
    }
    ...
    if ([str integerValue] < 20 && [str integerValue] >= 10) {
