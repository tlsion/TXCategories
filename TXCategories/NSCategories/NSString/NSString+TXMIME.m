...
@implementation NSString (TXMIME)
/**
...
- (NSString *)tx_MIMEType {
    return [[self class] tx_MIMETypeForExtension:[self pathExtension]];
}

+ (NSString *)tx_MIMETypeForExtension:(NSString *)extension {
    return [[self tx_MIMEDict] valueForKey:[extension lowercaseString]];
}
/**
 *  @brief  常见MIME集合
 *
