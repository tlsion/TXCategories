...
@interface NSRunLoop (TXPerformBlock)
/**
 *  @author ishkawa
 *
 ...
 */
- (void)tx_performBlockAndWait:(void (^)(BOOL *finish))block;
/**
 *  @author ishkawa
 *
 *  @brief   extension of NSRunLoop for waiting.
 ...
 *  @param block <#block description#>
 */
- (void)tx_performBlockAndWait:(void (^)(BOOL *finish))block timeoutInterval:(NSTimeInterval)timeoutInterval;
