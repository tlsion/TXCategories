...
@implementation NSDecimalNumber (TXCalculatingByString)

+ (NSDecimalNumber *)tx_decimalNumberWithEquation:(NSString *)equation decimalNumbers:(NSDictionary *)numbers
{
