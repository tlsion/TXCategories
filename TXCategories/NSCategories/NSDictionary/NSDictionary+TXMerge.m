...
@implementation NSDictionary (TXMerge)
/**
    ...
    [resultTemp enumerateKeysAndObjectsUsingBlock: ^(id key, id obj, BOOL *stop) {
        if ([dict1 objectForKey:key]) {
            if ([obj isKindOfClass:[NSDictionary class]]) {
                NSDictionary * newVal = [[dict1 objectForKey: key] tx_dictionaryByMergingWith: (NSDictionary *) obj];
        ...
        {
            if ([obj isKindOfClass:[NSDictionary class]]) {
                NSDictionary * newVal = [[dict2 objectForKey: key] tx_dictionaryByMergingWith: (NSDictionary *) obj];
                [result setObject: newVal forKey: key];
            } else {
                [result setObject: obj forKey: key];
            }
...
- (NSDictionary *)tx_dictionaryByMergingWith:(NSDictionary *)dict {
    return [[self class] tx_dictionaryByMerging:self with: dict];
}
